...
//                    System.out.println(response.getBody());
    ...
    public static ArrayList<JSONObject> httpConnect(String uri, int[] generatedNodeIds)  {
        ...
        ResponseEntity<ArrayList<JSONObject>> rateResponse = restTemplate.exchange(uri, HttpMethod.POST,
                requestEntity, new ParameterizedTypeReference<ArrayList<JSONObject>>() {});
