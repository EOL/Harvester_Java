...
public class StorageLayerClient {
    ...
    public void downloadResource(String resId, String isOrg) throws IOException {
    ...
    public void uploadDWCAResource(String resId, String fileName) throws IOException {
