...
public class RowValidationRule extends ValidationRule {
    private static final Logger logger = LoggerFactory.getLogger(RowValidationRule.class);
...
//            }
            ...
            logger.error("IllegalAccessException while trying to dynamically call method method");
            ...
            logger.error("Exception while trying to dynamically call method");
            logger.error("Stack Trace: ", e);
            return false;
        }
        return true;
