...
public class ScriptsHandler {
    ...
    public void runLoadNodes(String taxaFilePath, String resource_id, String node_id_col, String scientific_name_col, String rank_col, String generated_auto_id_col, String has_header) {
        ...
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder(PropertiesHandler.getProperty((String)"scriptsPath") + "taxa_load_nodes_with_ids.sh", taxaFilePath, resource_id, node_id_col, scientific_name_col, rank_col, generated_auto_id_col, has_header);
            Process p = null;
            p = pb.start();
            BufferedReader reader = new BufferedReader(new InputStreamReader(p.getInputStream()));
            String line = null;
