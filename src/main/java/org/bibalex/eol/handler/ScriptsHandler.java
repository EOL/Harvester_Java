...
public class ScriptsHandler {
    ...
    public void runLoadNodes (String taxaFilePath, String resource_id, String node_id_col, String scientific_name_col, String rank_col){
        ...
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder(PropertiesHandler.getProperty("scriptsPath")+"taxa_load_nodes_with_ids.sh", taxaFilePath, resource_id, node_id_col, scientific_name_col, rank_col);
            Process p = null;
            p = pb.start();
            BufferedReader reader = new BufferedReader(new InputStreamReader(p.getInputStream()));
            String line = null;
